...
dataProcessing = ["s", "b", "p", "b", "w", "w", "r", "l", "w", "r", "w", "g", "g", "s"]# Initialize the dataProcessing list with the first 4 elements of the datastream
j = 14# Initialize the counter including the first 4 elements of the datastream
